...
class AnimalFeedsPage extends StatefulWidget {
  @override
  State<AnimalFeedsPage> createState() => _AnimalFeedsPageState();
}

class _AnimalFeedsPageState extends State<AnimalFeedsPage> {
  String? _email;
  String? _role;
  ...
  List<ItemUI> items = [
    ItemUI(
        id: "",
        imageUrl: 'assets/layer.jpg', // Change this to your image path
        title: "Layer Chicken Feeds",
        price: 250.0,
        quantity: 0,
        available: true),
    ItemUI(
        id: "",
        imageUrl: 'assets/corn.jpg', // Change this to your image path
        title: "Corn chicken feeds",
        price: 220.0,
        quantity: 0,
        available: true),
    ItemUI(
        id: "",
        imageUrl: 'assets/starter.jpg', // Change this to your image path
        title: "Starter chicken Feeds",
        price: 250.0,
        quantity: 0,
        available: true),
    ItemUI(
        id: "",
        imageUrl: 'assets/cattle.png', // Change this to your image path
        title: "Cattle Feeds",
        price: 150.0,
        quantity: 0,
        available: true),
    ItemUI(
        id: "",
        imageUrl: 'assets/fish.png', // Change this to your image path
        title: "Fish Feeds",
        price: 1000.0,
        quantity: 0,
        available: true),
    ItemUI(
        id: "",
        imageUrl: 'assets/dog.jpg', // Change this to your image path
        title: "Dog Feeds",
        price: 300.00,
        quantity: 0,
        available: true),
    ItemUI(
        id: "",
        imageUrl: 'assets/cat.jpg', // Change this to your image path
        title: "Cat Feeds",
        price: 450.00,
        quantity: 0,
        available: true),
  ...
  Future<void> _fetchOrders() async {
    ...
    try {
      List<CustomerOrder> orders = (await _databaseService
              .getCustomerOrderByCustomerIdeAndCategory(customerEmail, 'Feeds'))
          .cast<CustomerOrder>();
      setState(() {
